      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          >
            ...
            >
              Ordiwalls is a project that brings a new dimension to the world of digital art. By holding and burning a specific token on the Ethereum blockchain, you will be able to access the Ordiwalls series on the BITCOIN blockchain.
              Via the Ordinals protocol, by interacting with your ETH token, you will not only obtain an Ordiwall NFT on the Ethereum blockchain, but also a corresponding NFT on the Bitcoin blockchain.
            </s.TextDescription>
            <s.SpacerMedium />
            ...
            > Ordiwalls offers a unique approach to creating digital art, with each piece being a one-of-a-kind masterpiece. A beautiful color palette is splashed on the walls,
              resulting in a stunning work of art. The rarity of each Ordiwall is determined by the actions of its holders on the blockchain, so be sure that you are following provided instructions closely.
